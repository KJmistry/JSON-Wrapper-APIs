/**
 * @file    json_utils.h
 * @brief   JSON utility library using Jansson.
 *
 * This library provides a convenient API for parsing, creating, modifying, 
 * and managing JSON data using the Jansson library. It simplifies common 
 * JSON operations such as serialization, deserialization, and data extraction.
 *
 * Dependencies:
 * - Jansson (https://digip.org/jansson/)
 *
 * Usage:
 * Include this header and link against the Jansson library to utilize 
 * JSON utilities for efficient data handling.
 *
 * License:
 * MIT License
 *
